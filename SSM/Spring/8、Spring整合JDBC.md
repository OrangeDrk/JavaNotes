...
![](..\img\SpringImg\Spring整合JDBC.png)
...
![](..\img\SpringImg\Spring声明式事务管理MVC结构.png)

## 在Spring配置文件导入相关约束

### 导入相关包

![](..\img\SpringImg\Spring声明式事务管理的相关jar包.png)
...
![](..\img\SpringImg\Spring声明式事务管理中事务管理、切面、通知的关系图.png)
