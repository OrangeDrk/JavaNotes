...
![](..\img\SpringImg\Spring AOP图解.png)
...
1. 导入aop相关的开发包
   ...
   ![](..\img\SpringImg\Spring AOP所需要的jar包.png)
...
3. 创建基本层级结构（==连接点==就是每层之间包含的对象【UserServlet中有UserServiceImpl对象】）
   ...
   ![](..\img\SpringImg\Spring AOP的三层结构.png)

4. 创建一个==切面类==

   ![](..\img\SpringImg\Spring AOP切面类.png)
...
1. 在within表达式中可以使用*号匹配符，匹配指定包下所有的类，
   ...
   ![](..\img\SpringImg\Spring AOP的within语法.png)
...
2. 在within表达式中也可以用*号匹配符
   ...
   ![](..\img\SpringImg\Spring AOP的within语法2.png)
...
3. 在within表达式中也可以用..*号匹配符
   ...
   ![](..\img\SpringImg\Spring AOP的within语法3.png)
...
1. Spring配置文件的配置
   ...
   > 图解：
   >
   > ![](..\img\SpringImg\后置通知配置文件与通知方法.png)
...
1. Spring配置文件的配置
   ...
   > 图解：
   >
   > ![](..\img\SpringImg\异常通知配置文件与通知方法.png)
...
![](..\img\SpringImg\多个切面下没有异常的5种通知执行流程.png)

#### 目标方法抛出异常

![](..\img\SpringImg\多个切面下抛出异常的5种通知执行流程.png)
...
4. 如果一个切面中多个通知用到相同的切入点表达式，则可以将该切入点表达式单独定义，后续引用。
   ...
   > **图示**：
   >
   > ![](..\img\SpringImg\AOP配置多个相同切入点.png)
