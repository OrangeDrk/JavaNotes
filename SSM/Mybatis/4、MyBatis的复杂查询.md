...
![](..\img\MyBatisImg\MyBatis一对一数据库视图.png)
...
> - SQL语句运行结果
>
>   ![](..\img\MyBatisImg\MyBatis一对一SQL语句查询结果.png)
...
![](..\img\MyBatisImg\MyBatis一对多数据库视图.png)
...
> SQL语句运行结果：
>
> ![](..\img\MyBatisImg\MyBatis一对多SQL语句查询结果.png)
...
![](..\img\MyBatisImg\MyBatis多对多数据库视图.png)
...
> SQL语句运行结果
>
> ![](..\img\MyBatisImg\MyBatis多对多SQL语句查询结果.png)
